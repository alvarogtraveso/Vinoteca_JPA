...
<div class="header">
	<div id="navigation">
		<ul id="cssdropdown">
			<li class="headlink"><a href="../home/home.do"><img id="logo" src="../img/menu.png"></a>		
				<ul>				
					<li><a href="../busqueda/busqueda_vinos.do?filtro_busqueda=tinto" >Tintos</a></li>
					<li><a href="../busqueda/busqueda_vinos.do?filtro_busqueda=blanco">Blancos</a></li>
					<li><a href="../busqueda/busqueda_vinos.do?filtro_busqueda=rosado">Rosados</a></li>
					<li><a href="#">&nbsp</a></li>
					<c:forEach var="b" items="${bodegas}">
							<li><a href="../busqueda/busqueda_vinos.do?filtro_busqueda=${b.nombre}">${b.nombre}</a></li>
					</c:forEach>
				</ul>
			</li>
			...
			<li class="headlink">
				<a id="carrito_icon" href="../pedido/carrito.do">Carrito [
					<script type="text/javascript">
						document.write(numVinosEnCarrito());
					</script>
				]</a>
			</li>
		</ul>
